...
namespace KhzCeoTicketingApi.Migrations
{
    ...
    [Migration("20251022091716_FixCascadeIssue")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KhzCeoTicketingApi.Domains.Entities.Appointment", b =>
                {
                    ...
                    b.Property<long?>("CurrentAssignmentUserId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("KhzCeoTicketingApi.Domains.Entities.AppointmentAssignment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("AssignDateFa")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("AppointmentAssignment");
                });

            modelBuilder.Entity("KhzCeoTicketingApi.Domains.Entities.AppointmentMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KhzCeoTicketingApi.Domains.Entities.AppointmentAssignment", b =>
                {
                    b.HasOne("KhzCeoTicketingApi.Domains.Entities.Appointment", "Appointment")
                        .WithMany("AppointmentAssignments")
            ...
            modelBuilder.Entity("KhzCeoTicketingApi.Domains.Entities.AppointmentMessage", b =>
                {
                    b.HasOne("KhzCeoTicketingApi.Domains.Entities.Appointment", "Appointment")
                        .WithMany("AppointmentMessages")
                        .HasForeignKey("AppointmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("KhzCeoTicketingApi.Domains.Entities.User", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("KhzCeoTicketingApi.Domains.Entities.Appointment", b =>
                {
                    b.Navigation("AppointmentAssignments");

                    b.Navigation("AppointmentMessages");
                });
